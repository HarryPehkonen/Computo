...
nlohmann::json map_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("map requires exactly 2 arguments");
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("map first argument must be array");
...
nlohmann::json filter_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("filter requires exactly 2 arguments");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("filter first argument must be array");
...
nlohmann::json reduce_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 3) throw InvalidArgumentException("reduce requires exactly 3 arguments");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("reduce first argument must be array");
...
nlohmann::json count_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 1) throw InvalidArgumentException("count requires exactly 1 argument");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("count argument must be array");
    return static_cast<int>(array_val.size());
}

nlohmann::json find_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("find requires exactly 2 arguments");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("find first argument must be array");
...
nlohmann::json some_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("some requires exactly 2 arguments");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("some first argument must be array");
...
nlohmann::json every_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("every requires exactly 2 arguments");
    auto array_val = evaluate(args[0], ctx);
    ...
    if (!array_val.is_array()) throw InvalidArgumentException("every first argument must be array");
...
nlohmann::json zip_op(const nlohmann::json& args, ExecutionContext& ctx) {
    if (args.size() != 2) throw InvalidArgumentException("zip requires exactly 2 arguments");
